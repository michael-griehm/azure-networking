resource "azurerm_private_dns_zone" "delta_lakehouse_blobs" {
...
resource "azurerm_private_dns_zone_virtual_network_link" "delta_lakehouse_databricks_spoke_link" {
...
resource "azurerm_private_dns_zone_virtual_network_link" "delta_lakehouse_storage_spoke_link" {
...
resource "azurerm_private_dns_zone" "delta_lakehouse_dfs" {
